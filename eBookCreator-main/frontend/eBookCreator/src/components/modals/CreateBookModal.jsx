...
const CreateBookModal = ({isOpen, onClose,onBookCreated}) => {
  ...
  const [numChapters,setNumChaapters] = useState(5);
    ...
    title="Create new Book">
      {step ===1 && (
        <div className='space-y-5'>
          ...
          value={bookTitle}
          onChange={(e)=>setBookTitle(e.target.value)}></InputField>
          <InputField 
          icon={Hash}
          ...
          placeholder="5"
          value={numChapters}
          onChange={(e)=>setNumChaapters(parseInt(e.target.value) || 1)}
          min="1"
          max="20"></InputField>
          <InputField 
          icon={Lightbulb}
          ...
          <SelectField
            ...
            <div className='flex justify-end pt-4'>
              ...
              icon={Sparkles}>Generate Outline with AI</Button>
            </div>
      ...
      {step===2 && (
        <div className='space-y-5'>
          ...
          <div ref={chaptersContainerRef} className='space-y-3 max-h-90 overflow-y-auto pr-1'>
            {chapters.length==0 ? (
              ...
              <div key={index} className='group p-4 border border-gray-200 rounded-xl hover:border-gray-300 hover:shadow-sm transition-all bg-white'>
                <div className='flex items-start gap-3 mb-3'>
                  ...
                  className='flex-1 text-base font-medium text-gray-900 bg-transparent border-none focus:outline-none focus-ring-0 p-0'></input>
                  <button onClick={()=>handleDeleteChapter(index)
                  } className='opacity-0 group-hover:opacity-100 p-1.5 rounded-lg hover:bg-red-50 transition' title='Delete Chapter'>
                ...
                placeholder='Breif description of what this chapter covers...'
                rows={2}
                className='w-full pl-9 text-sm text-gray-600 bg-transparent border-none focus:outline-none focus:ring-0 resize-none placeholder-gray-400'></textarea>
