            ...
            <div className='max-w-7xl mx-auto px-6 lg:px-8 py-24 relative'>
                <div className='grid grid-cols-1 lg:grid-cols-2 gap-16 items-center'>
                    <div className='max-w-xl space-y-8'>
                        <div className='inline-flex items-center space-x-2 bg-white/80 backdrop-blur-sm px-4 py-2 rounded-full border border-violet-100 shadow'>
                            <Sparkles className='w-4 h-4 text-violet-600'></Sparkles>
                            <span className='text-sm font-medium text-violet-900'>AI-Powered Publishing</span>

                        </div>
                        <h1 className='text-5xl sm:text-6xl lg:text-6xl font-bold text-gray-900 leading-tight tracking-tight'> Create Stunning
                        ...
                        <div className='flex flex-col sm:flex-row items-start sm:items-center gap-4'>
                            ...
                            <a href='#demo' className='inline-flex items-center space-x-2 text-gray-700 font-medium hover:text-violet-600 transition-colors duration-200'>
                                ...
                                <span className='text-violet-600'><ArrowRight></ArrowRight></span>
                            </a>
                        </div>
