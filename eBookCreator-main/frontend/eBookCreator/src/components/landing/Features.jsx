    ...
    >
      ...
      <div className='max-w-7xl mx-auto px-6 lg:px-8 relative'>
            ...
            return (
              ...
              >
                ...
                <div className='relative space-y-4'>
                  <div
                    className={`w-14 h-14 bg-gradient-to-br ${feature.gradient} rounded-xl flex items-center justify-center shadow-lg ${feature.shadow} group-hover:scale-110 transition-transform duration-300`}
                  >
        ...
        <div className='text-center mt-16'>
          ...
          <a
            href='/signup'
            className='inline-flex items-center space-x-2 bg-gradient-to-r from-violet-600 to-purple-600 text-white px-8 py-4 rounded-xl font-semibold shadow-lg shadow-violet-500/30 hover:shadow-violet-500/50 hover:scale-105 transition-all duration-300'
          >
