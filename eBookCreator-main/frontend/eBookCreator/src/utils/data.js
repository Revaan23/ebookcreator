...
export const FEATURES = [
  ...
  },
  {
    ...
    description:
      "Preview your ebook in a clean, read-only format. Adjust font sizes for a comfortable reading experience before publishing.",
    icon: BookOpen,
  ...
  },
  {
    ...
    description:
      "Organize all your ebook projects in a personal dashboard. Easily track progress, edit drafts, and manage versions.",
    icon: Library,
...
export const TESTIMONIALS = [
  ...
  {
    quote:
      "The one-click export feature saved me so much time. I was able to publish my ebook on multiple platforms effortlessly.",
    author: "Peter Jones",
