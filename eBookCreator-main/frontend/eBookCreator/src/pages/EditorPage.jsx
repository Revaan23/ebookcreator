...
const handleReorderChapters = (oldIndex, newIndex) => {
  ...
  // Keep selected chapter consistent
   ...
   return (
    ...
    <div className='flex bg-slate-50 font-sans relative min-h-screen'>
      {isSidebarOpen && (
        ...
        role='dialog'
        aria-modal="true">
          <div className='fixed inset-0 bg-black/50 bg-opacity-75 ' aria-hidden="true" onClick={()=>setIsSidebarOpen(false)}></div>
          <div className='relative flex-1 flex flex-col max-w-xs w-full bg-white'>
            ...
            onReorderChapter={handleReorderChapters}></ChapterSidebar>
          </div>
          <div className='flex-shrink-0 w-14' aria-hidden="true"></div>
        </div>
      )}

      <div className='hidden md:flex md:flex-shirnk-0 sticky top-0 h-screen'>
        <ChapterSidebar book={book}
        selectedChapterIndex={selectedChapterIndex}
        onSelectChapter={(index)=>{
          setSelectedChapterIndex(index);
      ...
      <main className='flex-1 h-full flex flex-col'>
        <header className='sticky top-0 z-10 bg-white/80 backdrop-blur-sm border-b border-slate-200 p-3 flex justify-between items-center'>
          <div className='flex items-center gap-2'>
            ...
            <div className='hidden sm:flex space-x-l bg-slate-100 p-1 rounded-lg'>
          ...
          <div className='flex items-center gap-2 sm:gap-4'>
            <Dropdown trigger={
              <Button variant='secondary' icon={FileDown}>Export 
              <ChevronDown className='w-4 h-4 ml-1'></ChevronDown></Button>
            }>
            ...
            <ChapterEditorTab 
              ...
              isGenerating={isGenerating}/>):(
                <BookDetailsTab
                  ...
                  fileInputRef={fileInputref}></BookDetailsTab>
              )
          }
        </div>
      </main>
