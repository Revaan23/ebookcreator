...
const LoginPage = () => {
  ...
  const handleSubmit = async(e)=>{
    ...
    try {
      ...
      const profileResponse = await axiosInstance.get(API_PATHS.AUTH.GET_PROFILE,{headers:{Authorization:`Bearer ${token}`},});
      ...
      <div className='w-full max-w-md'>
        ...
        <div className='bg-white border border-slate-200 rounded-xl shadow-lg p-8 '>
          ...
          <p className='text-center text-sm text-slate-600 mt-8'>
            ...
            <Link to="/signup" className='font-medium text-violet-600 hover:text-violet-700'>Sign up</Link>
          </p>
        </div>
      </div>
    </div>
